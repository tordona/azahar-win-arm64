				...
				DEFINE_OID(us_organization()+101, us_gov)
					DEFINE_OID(us_gov()+3, csor)
						DEFINE_OID(csor()+4, nistalgorithms)
							...
							// NIST Post-Quantum Cryptography OIDs
							// ML-DSA (FIPS 204) and SLH-DSA (FIPS 205) signatures
							DEFINE_OID(nistalgorithms()+3, nist_sigalgs)
								// ML-DSA (Module-Lattice Digital Signature Algorithm)
								DEFINE_OID(nist_sigalgs()+17, id_ml_dsa_44)
								DEFINE_OID(nist_sigalgs()+18, id_ml_dsa_65)
								DEFINE_OID(nist_sigalgs()+19, id_ml_dsa_87)
								// SLH-DSA (Stateless Hash-Based Digital Signature Algorithm)
								// SHA2 variants
								DEFINE_OID(nist_sigalgs()+20, id_slh_dsa_sha2_128s)
								DEFINE_OID(nist_sigalgs()+21, id_slh_dsa_sha2_128f)
								DEFINE_OID(nist_sigalgs()+22, id_slh_dsa_sha2_192s)
								DEFINE_OID(nist_sigalgs()+23, id_slh_dsa_sha2_192f)
								DEFINE_OID(nist_sigalgs()+24, id_slh_dsa_sha2_256s)
								DEFINE_OID(nist_sigalgs()+25, id_slh_dsa_sha2_256f)
								// SHAKE variants
								DEFINE_OID(nist_sigalgs()+26, id_slh_dsa_shake_128s)
								DEFINE_OID(nist_sigalgs()+27, id_slh_dsa_shake_128f)
								DEFINE_OID(nist_sigalgs()+28, id_slh_dsa_shake_192s)
								DEFINE_OID(nist_sigalgs()+29, id_slh_dsa_shake_192f)
								DEFINE_OID(nist_sigalgs()+30, id_slh_dsa_shake_256s)
								DEFINE_OID(nist_sigalgs()+31, id_slh_dsa_shake_256f)
							// ML-KEM (FIPS 203) key encapsulation
							DEFINE_OID(nistalgorithms()+4, nist_kemalgs)
								DEFINE_OID(nist_kemalgs()+1, id_ml_kem_512)
								DEFINE_OID(nist_kemalgs()+2, id_ml_kem_768)
								DEFINE_OID(nist_kemalgs()+3, id_ml_kem_1024)
